  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Salida</h5>
      ...
      <form action="codesalidaInv.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="ingresarSalida" class="btn btn-primary">Insertar</button>
        </div>
      </form>
...
<!-- Grilla de la pagina -->
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <form action="salidaInv_edit.php" method="post">
                    <input type="hidden" name="edit_id" value="<?php echo $row['id']; ?>">
                    <button  type="submit" name="editarSalida" class="btn btn-secondary"> <i class="fas fa-marker"></i></button>
                </form>
            </td>
        </tr>
            <?php
